...
class PythonParser(Parser):
    ...
    def invalid_try_stmt(self) -> Optional[NoReturn]:
        ...
        if (
            ...
            (self.block())
            and
            (self.negative_lookahead(self._tmp_214, ))
        ):
    ...
    def invalid_double_starred_kvpairs(self) -> Optional[None]:
        ...
        if (
            ...
            (a := self.expect(':'))
            and
            (self.positive_lookahead(self._tmp_232, ))
        ):
    ...
    def invalid_kvpair(self) -> Optional[None]:
        ...
        if (
            ...
            (a := self.expect(':'))
            and
            (self.positive_lookahead(self._tmp_233, ))
        ):
            return self . raise_syntax_error_known_location ( "expression expected after dictionary key and ':'" , a );
        self._reset(mark)
        if (
    ...
    def invalid_replacement_field(self) -> Optional[Any]:
        ...
        if (
            (self.expect('{'))
            and
            (self.negative_lookahead(self._tmp_234, ))
        ):
        ...
        if (
            ...
            (self.expect('='))
            and
            (self.negative_lookahead(self._tmp_238, ))
        ):
        ...
        if (
            ...
            (self._tmp_241(),)
            and
            (self.negative_lookahead(self._tmp_242, ))
        ):
    ...
    def invalid_conversion_character(self) -> Optional[Any]:
        ...
        if (
            (self.expect('!'))
            and
            (self.positive_lookahead(self._tmp_248, ))
        ):
    ...
    def _tmp_158(self) -> Optional[Any]:
        # _tmp_158: FSTRING_MIDDLE | fstring_replacement_field
        mark = self._mark()
        if (
    ...
    @memoize
    def _gather_230(self) -> Optional[Any]:
    ...
    def _loop0_245(self) -> Optional[Any]:
        # _loop0_245: fstring_format_spec
        mark = self._mark()
        children = []
        while (
            (fstring_format_spec := self.fstring_format_spec())
